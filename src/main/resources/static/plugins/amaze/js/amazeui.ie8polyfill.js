  ...
  if (!Object.create) {
    ...
    if (supportsProto || typeof document === 'undefined') {
      ...
      createEmpty = function () {
        ...
        // see https://github.com/es-shims/es5-shim/issues/150
        var empty = shouldUseActiveX() ? getEmptyViaActiveX()
            : getEmptyViaIFrame();
...
// https://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Objects/Array/reduce
  ...
  if (ArrayPrototype.reduce) {
    reduceCoercesToObject = typeof ArrayPrototype.reduce.call('es5',
...
// https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/indexOf
  ...
  defineProperties(ArrayPrototype, {
    indexOf: function indexOf(searchElement /*, fromIndex */) {
      var self = splitString && isString(this) ? this.split('') : ES.ToObject(
          this);
      var length = self.length >>> 0;
    ...
    keys: function keys(object) {
      ...
      if (hasDontEnumBug) {
        ...
        for (var j = 0; j < dontEnumsLength; j++) {
          ...
          if (!(skipConstructor && dontEnum === 'constructor') && owns(object,
              dontEnum)) {
...
// this object is not a finite Number a RangeError exception is thrown.
  ...
  var hasNegativeDateBug = Date.prototype.toISOString && new Date(
      negativeDate).toISOString().indexOf(negativeYearString) === -1;
...
// http://gist.github.com/303249
  var supportsExtendedYears = Date.parse('+033658-09-27T01:46:40.000Z')
      === 1e15;
  var acceptsInvalidDates = !isNaN(Date.parse('2012-04-04T24:00:00.500Z'))
      || !isNaN(Date.parse('2012-11-31T23:59:59.000Z')) || !isNaN(
          Date.parse('2012-12-31T23:59:60.000Z'));
...
// http://es5.github.com/#x15.7.4.5
  ...
  var toFixedHelpers = {
    ...
    pow: function pow(x, n, acc) {
      return (n === 0 ? acc : (n % 2 === 1 ? pow(x, n - 1, acc * x) : pow(x * x,
          n / 2, acc)));
    },
    log: function log(x) {
      var n = 0;
  ...
  defineProperties(NumberPrototype, {
    toFixed: function toFixed(fractionDigits) {
      ...
      if (x > 1e-21) {
        ...
        z = (e < 0 ? x * toFixedHelpers.pow(2, -e, 1) : x / toFixedHelpers.pow(
            2, e, 1));
        ...
        if (e > 0) {
          ...
          m = toFixedHelpers.numToString() + '0.00000000000000000000'.slice(2,
              2 + f);
        }
      }
    ...
    (function () {
      ...
      StringPrototype.split = function (separator, limit) {
        ...
        if (!compliantExecNpcg) {
          ...
          separator2 = new RegExp('^' + separatorCopy.source + '$(?!\\s)',
              flags);
        }
...
// "0".split(undefined, 0) -> []
  ...
  if (!replaceReportsGroupsCorrectly) {
    StringPrototype.replace = function replace(searchValue, replaceValue) {
      ...
      var hasCapturingGroups = isRegex(searchValue) && (/\)[*?]/).test(
          searchValue.source);
...
!window.addEventListener && (function (WindowPrototype, DocumentPrototype,
    ElementPrototype, addEventListener, removeEventListener, dispatchEvent,
    registry) {
  WindowPrototype[addEventListener] = DocumentPrototype[addEventListener] = ElementPrototype[addEventListener] = function (type,
      listener) {
    var target = this;
  ...
  WindowPrototype[removeEventListener] = DocumentPrototype[removeEventListener] = ElementPrototype[removeEventListener] = function (type,
      listener) {
    for (var index = 0, register; register = registry[index]; ++index) {
      if (register[0] == this && register[1] == type && register[2]
          == listener) {
      ...
      xhr = function (url, callback) { // create new XMLHttpRequest object and run it
        try {
          ...
          var xhr = window.ActiveXObject ? (new ActiveXObject(
              'Microsoft.XMLHTTP') || new ActiveXObject('Msxml2.XMLHTTP'))
              : new XMLHttpRequest();
...
!function (a) {
  ...
  a.matchMedia = a.matchMedia || function (a) {
    ...
    return f.id = "mq-test-1", f.style.cssText = "position:absolute;top:-100em", e.style.background = "none", e.appendChild(
      ...
      return f.innerHTML = '&shy;<style media="' + a
          + '"> #mq-test-1 { width: 42px; }</style>', c.insertBefore(e,
          d), b = 42 === f.offsetWidth, c.removeChild(e), {matches: b, media: a}
    }
  }(a.document)
}(this), function (a) {
  "use strict";
  ...
  var d = [], e = function () {
    ...
    c && (c.open("GET", a, !0), c.onreadystatechange = function () {
      4 !== c.readyState || 200 !== c.status && 304 !== c.status || b(
          c.responseText)
  ...
  if (c.ajax = f, c.queue = d, c.unsupportedmq = g, c.regex = {
    ...
    other: /\([^\)]*\)/g
  }, c.mediaQueriesSupported = a.matchMedia && null !== a.matchMedia("only all")
    ...
    var h, i, j, k = a.document, l = k.documentElement, m = [], n = [], o = [],
        ...
        t = r.getElementsByTagName("link"), u = function () {
          ...
          || (c = f = k.createElement(
              ...
              ? l.removeChild(c) : c.removeChild(b), l.style.fontSize = d, e
          && (c.style.fontSize = e), a = j = parseFloat(a)
        }, v = function (b) {
          var c = "clientWidth", d = l[c],
              e = "CSS1Compat" === k.compatMode && d || k.body[c] || d, f = {},
              g = t[t.length - 1], p = (new Date).getTime();
          if (b && h && q > p - h) {
            return a.clearTimeout(i), i = a.setTimeout(v,
                q), void 0;
          }
          h = p;
          for (var s in m) {
            if (m.hasOwnProperty(s)) {
              var w = m[s], x = w.minw, y = w.maxw, z = null === x, A = null === y,
                  B = "em";
              x && (x = parseFloat(x) * (x.indexOf(B) > -1 ? j || u() : 1)), y
              && (y = parseFloat(y) * (y.indexOf(B) > -1 ? j || u()
                  : 1)), w.hasquery
              && (z && A || !(z || e >= x) || !(A || y >= e)) || (f[w.media]
              || (f[w.media] = []), f[w.media].push(n[w.rules]))
            }
          }
          for (var C in o) {
            o.hasOwnProperty(C) && o[C] && o[C].parentNode === r
            && r.removeChild(o[C]);
          }
          o.length = 0;
          for (var D in f) {
            if (f.hasOwnProperty(D)) {
              ...
              E.type = "text/css", E.media = D, r.insertBefore(E,
                  g.nextSibling), E.styleSheet ? E.styleSheet.cssText = F
                  : E.appendChild(k.createTextNode(F)), o.push(E)
            }
          }
        }, w = function (a, b, d) {
          var e = a.replace(c.regex.comments, "").replace(c.regex.keyframes,
          ...
          for (var j = 0; f > j; j++) {
            var k, l, o, p;
            i ? (k = d, n.push(h(a))) : (k = e[j].match(c.regex.findStyles)
                && RegExp.$1, n.push(RegExp.$2 && h(RegExp.$2))), o = k.split(
                ","), p = o.length;
            for (var q = 0; p > q; q++) {
              l = o[q], g(l) || m.push({
          ...
          for (var b = 0; b < t.length; b++) {
            ...
            e && g && !p[e] && (c.styleSheet && c.styleSheet.rawCssText ? (w(
                c.styleSheet.rawCssText, e, f), p[e] = !0)
                : (!/^([a-zA-Z:]*\/\/)/.test(e) && !s || e.replace(RegExp.$1,
                "").split("/")[0] === a.location.host) && ("//" === e.substring(0,
                2) && (e = a.location.protocol + e), d.push({href: e, media: f})))
          }
          x()
        };
    y(), c.update = y, c.getEmValue = u, a.addEventListener
        ? a.addEventListener("resize", b, !1) : a.attachEvent && a.attachEvent(
        "onresize", b)
  }
}(this);