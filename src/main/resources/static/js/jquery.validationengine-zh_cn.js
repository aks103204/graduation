        ...
        newLang:function(){
            $.validationEngineLanguage.allRules = {
                ...
                "phone":{
                    ...
                    "regex":/^(0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8})|(400|800)([0-9\\-]{7,10})|(([0-9]{4}|[0-9]{3})(-| )?)?([0-9]{7,8})((-| |转)*([0-9]{1,4}))?$/,
                    "alertText":"* 无效的电话号码"
                },
                "mobilephone":{   
                     "regex": /^(1)\d{10}$/,
                ...
                "passport":{
                    "regex":/^(P\d{7}|G\d{8}|S\d{7,8}|D\d+|1[4,5]\d{7})$/,
                    "alertText":"* 无效的护照号码"
                },
                "businessLicNo":{
                    "regex":/^\d{6}[123]\d{7}[1-9]$/,
                    "alertText":"* 无效的营业执照注册号"
                },
                "orgCd":{
                    "regex":/^([A-Z0-9]{8}-[A-Z0-9]|\d{18})$/,
                    "alertText":"* 无效的统一社会信用代码/组织机构代码"
                }
            };
